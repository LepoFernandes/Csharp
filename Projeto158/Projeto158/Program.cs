...
namespace Curso
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Worker worker = new Worker(level, name, valueSalary, dept);
            ...
            for (int i = 1; i <= N; i++)
            {
                ...
                HourContract contract = new HourContract(dateContract, valueHour, durationHours);
